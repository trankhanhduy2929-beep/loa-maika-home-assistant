...
Từ bản `1.5.0`, integration có thể cast một file MP3 cố định tới loa MAIKA sau khi rule HASS chạy thành công:

1. Bật **Cast âm thanh cloud thử nghiệm**.
2. Bật sensor/rule câu lệnh.
3. Dán URL HTTP(S) của file MP3 vào **URL MP3 báo thành công**; để trống là tắt.
4. Nếu config entry có nhiều loa, chọn media player MAIKA cần phát. Với đúng một loa, integration tự chọn và ẩn trường chọn loa.
...
└── gửi trực tiếp MAIKA cloud cast Play với URL đã lưu và audio/mpeg
