...
Từ portal tự phục vụ, người dùng có thể đăng nhập Google (khi OAuth đã cấu
hình) hoặc đăng ký bằng email/SĐT + mật khẩu, nhận trial 1 ngày, mua gói 1
tháng/vĩnh viễn qua PayOS và xem lại lịch sử/key cũ. License và
installation đã tồn tại trước portal tiếp tục hoạt động; người dùng chỉ cần nhập
key cũ một lần trong portal nếu muốn gắn nó vào tài khoản để xem lại sau này.
...
python3 scripts/configure_licensing.py \
  ...
  --portal-url https://YOUR-PORTAL.vercel.app \
